  ...
  return (
    <div className="bg-black text-white min-h-screen relative overflow-x-hidden pt-24 pb-12" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[-10%] w-[600px] h-[600px] rounded-full blur-[150px]" style={{ background: "rgba(123,63,228,0.06)" }} />
        <div className="absolute bottom-[20%] right-[-10%] w-[600px] h-[600px] rounded-full blur-[150px]" style={{ background: "rgba(123,63,228,0.04)" }} />
      </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-4xl text-center md:text-left">
            ...
            >
              ...
              <span className="text-xs font-semibold tracking-[0.4em] uppercase" style={{ color: "#7B3FE4" }}>Capabilities</span>
            </motion.div>
            ...
            >
              We Engineer the <br />
              <span style={{ color: "#7B3FE4" }}>Growth Protocols</span><br />
              of Dominant Brands.
            </motion.h1>
      ...
      <section className="py-20 relative z-10 border-t border-white/8 bg-black">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl mb-16 text-center md:text-left">
            <span className="text-xs font-semibold uppercase tracking-[0.4em] mb-4 block" style={{ color: "#7B3FE4" }}>Interactive Preview</span>
            <h2 className="text-3xl md:text-5xl font-black" style={{ letterSpacing: "-0.02em" }}>
              Capability <span style={{ color: "#7B3FE4" }}>Blueprint Console</span>
            </h2>
            <p className="text-white/40 text-sm mt-4 font-normal">
              Click any service on the left to see its detailed breakdown and expected growth velocity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              {blueprintData.map((blueprint, index) => (
                <button
                  ...
                  className={`w-full text-left p-5 rounded-[20px] border transition-all duration-300 flex items-center justify-between group cursor-pointer ${
                    activeTab === index 
                      ? "border-[#7B3FE4]/40 bg-[#7B3FE4]/5" 
                      : "bg-[#0a0a0a] border-white/10 hover:border-white/20"
                  }`}
                >
                  <span className={`text-xs font-semibold transition-colors ${
                    activeTab === index ? "text-white" : "text-white/50 group-hover:text-white"
                  }`}>
                    {blueprint.title}
                  </span>
                  <FiArrowRight className={`w-4 h-4 transition-all ${
                    activeTab === index ? "text-[#7B3FE4] translate-x-1" : "text-white/20 group-hover:text-white"
                  }`} />
                </button>
              ))}
            </div>
            ...
            <div className="lg:col-span-8">
              <div className="h-full rounded-[24px] bg-[#0a0a0a] border border-white/10 p-8 flex flex-col justify-between shadow-2xl relative min-h-[420px]">
                  ...
                  <div className="md:col-span-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 rounded-2xl bg-zinc-950/40 border border-white/5">
                        ...
                        <span className="text-xs font-bold" style={{ color: "#7B3FE4" }}>{blueprintData[activeTab].multiplier}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 rounded-2xl bg-black/40 border border-white/5 p-5 font-mono text-[10px] text-white/50 space-y-2 flex flex-col justify-start min-h-[180px]">
                      ...
                      {terminalLogs.map((log, idx) => (
                        <div key={idx} className="flex gap-2 leading-relaxed">
                          <span style={{ color: "#7B3FE4" }} className="font-bold">▶</span>
                          <span>{log}</span>
                        </div>
                      ))}
                ...
                <div className="border-t border-white/5 pt-6 mt-6 flex justify-end font-sans">
                  <Link
                    href="/contact"
                    className="px-6 h-11 rounded-full text-white text-xs font-semibold flex items-center gap-2 cursor-pointer transition-all duration-200 shadow-lg"
      ...
      <section className="py-24 relative z-10 border-t border-white/8 bg-black">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl mb-20 text-center md:text-left">
            <span className="text-xs font-semibold uppercase tracking-[0.4em] mb-4 block" style={{ color: "#7B3FE4" }}>Services Directory</span>
            <h2 className="text-3xl md:text-5xl font-black" style={{ letterSpacing: "-0.02em" }}>
              Core <span style={{ color: "#7B3FE4" }}>Capabilities</span>
            </h2>
          </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative p-8 bg-[#0a0a0a] border border-white/10 rounded-[24px] hover:border-white/20 transition-all duration-400 overflow-hidden"
                >
                  ...
                  <div className="relative z-10">
                    <div className="mb-6 w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-105 transition-all" style={{ background: "rgba(123,63,228,0.12)" }}>
      ...
      <section className="py-24 relative z-10 border-t border-white/8 bg-black">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl mb-20 text-center md:text-left">
            <span className="text-xs font-semibold uppercase tracking-[0.4em] mb-4 block" style={{ color: "#7B3FE4" }}>Competitor Scrutiny</span>
            <h2 className="text-3xl md:text-5xl font-black" style={{ letterSpacing: "-0.02em" }}>
              The High-Velocity <br />
              <span style={{ color: "#7B3FE4" }}>Framework Battle</span>
            </h2>
          ...
          <div className="p-8 rounded-[24px] bg-[#0a0a0a] border border-white/10 overflow-x-auto">
            <table className="w-full min-w-[700px] border-collapse text-left select-none">
              <thead>
                <tr className="border-b border-white/5 pb-4 text-[10px] font-black uppercase text-white/30 tracking-[0.2em]">
                  ...
                  <th className="py-4 pl-6" style={{ color: "#7B3FE4" }}>SocialFlipss Protocol</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="py-24 relative z-10 border-t border-white/8 bg-black overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl relative z-10 text-center space-y-10">
          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight mb-4" style={{ letterSpacing: "-0.03em" }}>
            Ready to Audit<br />
            <span style={{ color: "#7B3FE4" }}>Your Pipeline?</span>
          </h2>

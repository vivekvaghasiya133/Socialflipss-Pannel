...
const TRANSLATIONS = {
  ...
  gu: {
    steps: ["Business Info", "Goals & Services", "Content Preferences", "Final Details"],
    invalidLink: "Invalid Link",
    invalidLinkDesc: "This onboarding link is invalid. Please contact the administrator.",
    alreadyComplete: "Onboarding Already Completed!",
    alreadyCompleteDesc: "Your onboarding is already completed. The SocialFlipss team will contact you shortly.",
    completeTitle: "Onboarding Completed! 🎉",
    completeDesc: (businessName) => `${businessName} — Your onboarding has been successfully submitted! The SocialFlipss team will contact you within 24 hours. Welcome to the family! 🙌`,
    clientOnboarding: "Client Onboarding",
    welcome: (name, business) => `Welcome, ${name} — ${business}`,
    stepOf: (step, total) => `Step ${step} of ${total}`,
    agreementText: "I confirm that all information provided is accurate and SocialFlipss will keep my data confidential.",
    agreementError: "Please accept the agreement to submit.",
    back: "← Back",
    next: "Next →",
    submit: "Submit ✓",
    ...
    instagramPlaceholder: "@yourpage",
    descriptionLabel: "What does your business do?",
    descriptionPlaceholder: "Give a brief description of your business...",
    audienceLabel: "Target Audience",
    audiencePlaceholder: "Describe your ideal customers (age, gender, location...)",
    servicesLabel: "Core Services / Products",
    servicesPlaceholder: "Write your main 3-5 services...",
    competitorsLabel: "Competitors",
    competitorsPlaceholder: "List your main competitors...",
    uspLabel: "USP — What makes your business special?",
    uspPlaceholder: "Why should customers choose you over others?",
    
    // Step 1: Goals & Services
    step1Title: "Goals & Services",
    step1Desc: "Select your social media goals and required services.",
    platformsLabel: "Which platforms are you active on?",
    platformsOptions: ["Instagram", "Facebook", "YouTube", "Google Business Profile", "LinkedIn", "No presence yet"],
    goalsLabel: "What is your main goal?",
    goalsOptions: [
    ...
    // Step 2: Content Preferences
    step2Title: "Content Preferences",
    step2Desc: "Tell us about your brand tone and content preferences.",
    toneLabel: "What tone / vibe should your brand have?",
    toneOptions: [
      "Professional / corporate",
      "Friendly / conversational",
      "Fun / trendy / youthful",
    ...
    contentTypesLabel: "What type of content do you prefer?",
    contentTypesOptions: [
      "Reels / short videos",
    ...
    colorsPlaceholder: "Preferred colors, fonts, style ideas...",
    inspirationLabel: "Inspiration / References",
    inspirationPlaceholder: "Competitor pages or reference links...",
    
    // Step 3: Final Details
    step3Title: "Final Details & Preferences",
    step3Desc: "Final notes, meeting time, and agreement.",
    prevExpLabel: "Have you worked with a marketing agency before?",
    prevExpOptions: [
      "No, this is my first time",
      "Yes — good experience",
    ...
    contactTimeLabel: "Best time to contact / meeting",
